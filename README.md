...
* **`baseline_models.py`**: Implementations of classic and modern models including **Burton (1975)**, **OBM (2005)**, and **DDM#1-3** (from https://doi.org/10.1016/j.jocs.2026.102821).
...
```bash
python plot_best_equations.py --csv results.csv --features Vp,Np,Bzsouth,Bmag,By,DST --output_dir ./plots/ --topk 5 --mode template
```
---

### 5. Extra notebook

The `plot-storm-and-get-metrics.ipynb` notebook allows you to generate the plots and csvs of the time-series predictions of a particular equation on the test storm and compute performance metrics: RMSE, MAE, CC, R2 and BFE.
